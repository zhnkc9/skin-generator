...
[[maybe_unused]] __declspec(dllexport) void generate(const char *game_path) {
    try {
        ...
        // 手动复制
       CopyDirectoryContents("D:\\C++\\skin-generator\\resource\\source", modPath);
...
//        }
        ...
        RENDER_TEMPLATE_TO_FILE(R"(D:\C++\skin-generator/resource/skinprefabs.tpl)", renderData, modPath / SkinPrefabsWritePath);
        RENDER_TEMPLATE_TO_FILE(R"(D:\C++\skin-generator/resource/clothing.tpl)", renderData, modPath / ClothingWritePath);
        RENDER_TEMPLATE_TO_FILE(R"(D:\C++\skin-generator/resource/register_inv.tpl)", renderData, modPath / RegisterSkinWritePath);
        RENDER_TEMPLATE_TO_FILE(R"(D:\C++\skin-generator/resource/modinfo.tpl)", renderData, modPath / ModInfoWritePath);
        RENDER_TEMPLATE_TO_FILE(R"(D:\C++\skin-generator/resource/modmain.tpl)", renderData, modPath / ModMainWritePath);
        RENDER_TEMPLATE_TO_FILE(R"(D:\C++\skin-generator/resource/init.tpl)", renderData, modPath / ModInitWritePath);
